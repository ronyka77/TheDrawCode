"""
CatBoost Model for Soccer Draw Prediction
...
experiment_name = "catboost_soccer_prediction_25"
...
def optimize_hyperparameters(
    ...
    storage_url = "sqlite:///optuna_catboost.db"
...
def hypertune_catboost():
    """
    Main training function with MLflow tracking.
    Updated name from hypertune_mlp to hypertune_catboost to match notebook.
    Args:
...
def main():
    ...
    try:
        ...
        current_params, current_metrics = hypertune_catboost()
