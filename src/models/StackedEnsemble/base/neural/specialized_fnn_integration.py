...
from src.models.StackedEnsemble.base.neural.pytorch_hypertuner import (
    load_hyperparameter_space,
)
from src.models.StackedEnsemble.base.neural.pytorch_hypertuner import main as original_main
...
# Setup logger
logger = ExperimentLogger("specialized_fnn_experiment")
...
def main():
    ...
    try:
        ...
        logger.info(
            f"Running hypertuner with specialized FNN model using experiment name: {hypertuner.experiment_name}"
        )
        original_main()
