...
class BaseModel(ABC):
    ...
    def __init__(
        self, model_type: str, experiment_name: str = None, logger: ExperimentLogger = None
    ):
    ...
    def optimize_hyperparameters(
        self, X: Any, y: Any, X_val: Any, y_val: Any, X_test: Any, y_test: Any
    ) -> dict[str, Any]:
    ...
    def fit(
        ...
        **kwargs,
        ...
        try:
            ...
            return {"precision": 0.0, "recall": 0.0, "f1": 0.0, "auc": 0.0, "brier_score": 1.0}
