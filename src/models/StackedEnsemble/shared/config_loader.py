...
class ConfigurationLoader:
    ...
    def __init__(
        ...
        self.logger = logger or ExperimentLogger(
            experiment_name=experiment_name or f"{model_type}_config_loader"
        )
    ...
    def _validate_model_config(self, config: dict[str, Any], model_type: str) -> None:
        ...
        required_fields = {
            "model": {
                ...
                "experiment_name": str,
                "cpu_config": dict,
                "logging": {"log_dir": str, "metrics_tracking": list},
            }
        }
    ...
    def _validate_dict_structure(
        self, data: dict[str, Any], required_structure: dict[str, Any], context: str
    ) -> None:
        ...
        for key, value_type in required_structure.items():
            ...
            if isinstance(value_type, dict):
                if not isinstance(data[key], dict):
                    raise ValueError(f"Field '{key}' in {context} must be a dictionary")
