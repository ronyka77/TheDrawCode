...
class OptunaValidator:
    ...
    def _create_study(self) -> optuna.Study:
        ...
        study = optuna.create_study(
            study_name=self.study_name, direction=self.direction, sampler=sampler, pruner=pruner
        )
                ...
                if param_type == "int":
                    ...
                    if distribution == "log_uniform":
                        params[param_name] = trial.suggest_float(
                            param_name, param_config["min"], param_config["max"], log=True
                        )
        ...
        try:
            ...
            results = {
                ...
                "optimization_history": [
                    {"trial": t.number, "value": t.value, "params": t.params, "state": t.state.name}
