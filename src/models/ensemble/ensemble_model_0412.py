...
from src.models.ensemble.meta_features_0412 import (
...
from src.models.ensemble.weights_0412 import compute_precision_focused_weights_optimized
...
class EnsembleModel(BaseEstimator, ClassifierMixin):
    def __init__(
        ...
        self.mlp_run_id = "f9725a6768f64e23904e0cc14ab1c010"
        self.pytorch_run_id = "54c6f88b705f4394b87995d28b969936"
        ...
        self.min_recalls = [0.30, 0.20, 0.30, 0.40, 0.30, 0.30, 0.30]  # Added SVM recall
        ...
        num_models = 7  # Updated number of models (added SVM)
    ...
    def train(
        ...
        prepare_data(X_train, X_train.columns)
    ...
    def predict_proba(self, X) -> np.ndarray:
        ...
        try:
            ...
            if not isinstance(X_pytorch, pd.DataFrame):
                self.logger.warning(
                    "X_pytorch is not a DataFrame before scaling. Attempting conversion."
                )
    ...
    def load_models_from_mlflow(
        ...
        try:
            ...
            pytorch_scaler_path = (
                "scaler/scaler_pytorch.pkl"  # Assuming scaler saved in 'scaler' dir
            )
        ...
        try:
            ...
            if not isinstance(
                self.model_svm_scaler, (StandardScaler, sklearn.preprocessing.RobustScaler)
            ):  # Add other expected scaler types if needed
                self.logger.warning(
                    f"Loaded SVM scaler is of unexpected type: {type(self.model_svm_scaler).__name__}"
                )
