...
def create_meta_features_optimized(
    ...
    Now handles 7 base models (incl. PyTorch, SVM).
    ...
    all_preds = [p_xgb, p_tabnet, p_lgb, p_extra, p_mlp, p_pytorch, p_svm]
    ...
    all_diffs = [
        ...
        diff_xgb_mlp,
        diff_xgb_pytorch,
        diff_xgb_svm,  # xgb vs others
        diff_tabnet_lgb,
        diff_tabnet_extra,
        diff_tabnet_mlp,
        diff_tabnet_pytorch,
        diff_tabnet_svm,  # tabnet vs others
        diff_lgb_extra,
        diff_lgb_mlp,
        diff_lgb_pytorch,
        diff_lgb_svm,  # lgb vs others
        diff_extra_mlp,
        diff_extra_pytorch,
        diff_extra_svm,  # extra vs others
        diff_mlp_pytorch,
        diff_mlp_svm,  # mlp vs others
        diff_pytorch_svm,  # pytorch vs svm
    ]
    ...
    vote_thresholds = [
        ...
        thresholds.get("pytorch", default_threshold)
        if thresholds
        else default_threshold,  # Added PyTorch
...
def create_meta_dataframe(meta_features: np.ndarray) -> pd.DataFrame:
    ...
    col_names = (
        ["p_xgb", "p_tabnet", "p_lgb", "p_extra", "p_mlp", "p_pytorch", "p_svm"]  # 7 base
        + ["weighted_avg"]  # 1 avg
        + [
            "diff_xgb_tabnet",
            "diff_xgb_lgb",
