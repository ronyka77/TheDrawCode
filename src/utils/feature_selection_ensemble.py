...
if __name__ == "__main__":
    ...
    features_combined[numeric_cols] = features_combined[numeric_cols].fillna(
        features_combined[numeric_cols].mean()
    )
    features_val[numeric_cols] = features_val[numeric_cols].fillna(
        features_combined[numeric_cols].mean()
    )
    ...
    selected_features = select_features_differentiated(
        features_combined, target_combined, features_val, target_val, verbose=True
    )
