...
def delete_small_log_files(logs_dir: str = "logs", max_size_kb: int = 5) -> None:
    ...
    print(f"🔍 Scanning for .log files in '{logs_dir}' and subfolders that are {max_size_kb}KB or smaller...")
    ...
    for log_file in log_files:
        try:
            ...
            if file_size <= max_size_bytes:
                ...
                print(f"⏭️  Skipped: {relative_path} ({file_size_kb:.2f}KB) - larger than {max_size_kb}KB")
...
def main():
    ...
    print(f"⚠️  This script will delete .log files {max_size_kb}KB or smaller from '{logs_dir}' folder.")
