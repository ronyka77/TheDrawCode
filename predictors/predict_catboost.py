...
class DrawPredictor:
    ...
    def __init__(self, model_uri: str):
        ...
        self.required_columns = get_selected_columns_draws()
        # Load the threshold from the model if available
        self.threshold = getattr(self.model, 'confidence_threshold', 0.5)
...
def main():
    ...
    model_uris = [
        'e9598913ca0a408797d826a6f4bec158',
        '756adce0b95c4a41854a1e3bbaaf927b',
        '210b4cbfbffc4218ab6d239d579f8936',
        'bc5b0f9290f04b7286bada1ea0dc37fa'
    ]
    ...
    if best_model_uri:
        ...
        # Save results
        output_path = Path("./data/prediction/predictions_catboost.xlsx")
