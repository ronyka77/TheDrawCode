...
class XGBoostModel(BaseEstimator, ClassifierMixin):
    ...
    def __init__(
        ...
        # Start of Selection
        self.global_params = {
            'learning_rate': 0.0066949417227311165,
            'min_child_weight': 32,
            'gamma': 17.149241375381244,
            'subsample': 0.9713862206482033,
            'colsample_bytree': 0.9797471264371405,
            'scale_pos_weight': 3.047679939698113,
            'reg_alpha': 0.12633299462162423,
            'reg_lambda': 6.413702478355093,
            'n_estimators': 7286,
