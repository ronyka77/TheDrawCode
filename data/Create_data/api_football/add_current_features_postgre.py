...
class PostgreSQLFeatures:
    ...
    def export_to_excel(self, fixtures_dataframe: pd.DataFrame, file_path: str) -> None:
        ...
        try:
            ...
            export_to_xlsx_fast(fixtures_dataframe, file_path)
    ...
    def export_events(self) -> pd.DataFrame:
        """
...
def main():
    ...
    export_to_xlsx_fast(fixtures_dataframe_final, export_path)
    ...
    export_to_xlsx_fast(fixtures_with_predictions, export_path)
