...
def select_features(
    X: pd.DataFrame, y: pd.Series, top_k: Optional[int] = 50, verbose: bool = True
) -> list[str]:
    """
    ...
    xgb_model = XGBClassifier(random_state=42, tree_method="hist", n_estimators=100, verbosity=0)
    ...
    models = {"xgb": xgb_model, "cat": cat_model, "lgbm": lgbm_model}
